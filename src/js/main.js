...
gsap.from(".promo__btn", {opacity: 0, scale: 2, ease: "power2.out", duration: 1, delay: 1.6});
gsap.from(".country__item", {opacity: 0, y: -500, ease: "power2.out", duration: 1, delay: 2, stagger: 0.2,});
